      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-6 gap-y-12 gap-x-8">
        <div class="lg:col-span-2 lg:pr-8">
          ...
          <div class="flex items-center gap-4 mt-6">
            <a href="https://x.com/xavvi" target="_blank" rel="noopener" class="text-[#212226]/60 hover:text-[#212226] transition-colors" aria-label="X">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://instagram.com/xavvi" target="_blank" rel="noopener" class="text-[#212226]/60 hover:text-[#212226] transition-colors" aria-label="Instagram">
            ...
            <a href="https://linkedin.com/company/xavvi" target="_blank" rel="noopener" class="text-[#212226]/60 hover:text-[#212226] transition-colors" aria-label="LinkedIn">
