...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/agencies', name: 'agencies', component: () => import('@/pages/AgenciesPage.vue'), meta: { title: 'Agencies & MCNs – Xavvi', description: 'Agencies and MCNs: help your network unlock new revenue streams powered by AI, social commerce, and blockchain technology.' } },
